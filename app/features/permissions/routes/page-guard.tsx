...
export default function PageGuard() {
  ...
  //
  // Renders the same loader as root.tsx's HydrateFallback (not null) —
  // hydration swaps the fallback out for this route tree before Supabase has
  // resolved the session, and returning null here left a blank gap between
