...
export const STATUS_META: Record<
  ClientStatus,
  { label: string; dot: string; badge: string; wash: string }
> = {
  not_contacted: {
    label: "Not contacted",
    dot: "bg-muted/60",
    badge: "bg-line/50 text-muted",
    wash: "border-line/60 bg-line/[0.06]",
  },
  contacted: {
    label: "Contacted",
    dot: "bg-blue-400",
    badge: "bg-blue-400/10 text-blue-400",
    wash: "border-blue-400/20 bg-blue-400/[0.05]",
  },
  replied: {
    label: "Replied",
    dot: "bg-royal-gold",
    badge: "bg-royal-gold/10 text-royal-gold",
    wash: "border-royal-gold/20 bg-royal-gold/[0.05]",
  },
  negotiating: {
    label: "Negotiating",
    dot: "bg-purple-400",
    badge: "bg-purple-400/10 text-purple-400",
    wash: "border-purple-400/20 bg-purple-400/[0.05]",
  },
  won: {
    label: "Won",
    dot: "bg-light-green",
    badge: "bg-light-green/10 text-light-green",
    wash: "border-light-green/20 bg-light-green/[0.05]",
  },
  lost: {
    label: "Lost",
    dot: "bg-loss",
    badge: "bg-loss/10 text-loss",
    wash: "border-loss/20 bg-loss/[0.05]",
  },
  ghosted: {
    label: "Ghosted",
    dot: "bg-orange-400",
    badge: "bg-orange-400/10 text-orange-400",
    wash: "border-orange-400/20 bg-orange-400/[0.05]",
  },
};
...
export const is_stale = (
  c: Pick<Client, "status" | "last_contact_at">,
): boolean =>
  (c.status === "contacted" || c.status === "replied") &&
  !!c.last_contact_at &&
  days_since(c.last_contact_at) >= 7;
...
export const api = {
  ...
  update: (
    ...
    supabase
      ...
      .select()
      .single(),
  remove: (id: string) => supabase.from("clients").delete().eq("id", id),
};
