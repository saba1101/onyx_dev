...
export const AuthShell = ({ title, subtitle, children, footer }: auth_shell_props) => (
  ...
  >
    <span className="absolute inset-x-0 top-0 h-0.5 bg-gradient-to-r from-watermelon via-royal-gold to-watermelon" />
    ...
    <div className="p-6">
      <div className="mb-6 flex items-center justify-between">
        ...
        <span className="flex items-center gap-1.5 text-[10px] uppercase tracking-wider text-muted">
          <span className="h-1.5 w-1.5 rounded-full bg-royal-gold" />
          secure
        </span>
      </div>

      <p className="text-[11px] uppercase tracking-wider text-watermelon">// access</p>
